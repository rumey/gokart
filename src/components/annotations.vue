          ...
          <div class="tabs-panel is-active" id="annotations-edit" v-cloak>
            ...
            <div class="tool-slice row collapse">
              <div class="small-12">
                ...
                <div class="expanded button-group">
                  <label class="button " for="uploadAnnotations" title="Support GeoJSON(.geojson), GPS data(.gpx)"><i class="fa fa-upload"></i> Import Editing </label><input type="file" id="uploadAnnotations" class="show-for-sr" name="annotationsfile" accept=".geojson,.gpx" v-model="annotationsfile" v-el:annotationsfile @change="importAnnotations()"/>
